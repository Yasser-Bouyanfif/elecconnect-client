          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">+33 6 98 65 77 80</span>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-4 h-4 text-emerald-400" />
                <span className="text-gray-300">contact@elecconnect.fr</span>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin className="w-4 h-4 text-emerald-400 mt-1" />
                <span className="text-gray-300">Provence-Alpes-Côte d'Azur</span>
              </li>
            </ul>
          </div>
        </div>
