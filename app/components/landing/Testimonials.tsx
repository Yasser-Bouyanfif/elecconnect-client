                ...
                >
                  {reviews.map((d) => (
                    <SwiperSlide
                      ...
                      // petit halo pour la carte active
                      style={{
                        boxShadow:
                    ...
                    >
                      <div className="w-[86%] mx-auto h-full flex flex-col justify-between py-8">
                        <div>
                          <p className="text-[13px] sm:text-sm md:text-[15px] font-semibold text-slate-800">
                            {d.review}
                          </p>
